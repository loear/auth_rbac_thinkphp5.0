$(document).ready(function() {
    ...
    decoration.show_dialog_module_html = function($dialog, content) {
        ...
        if($('#module_html_editor').hasClass('render')){
            $('#module_html_editor').css("visibility","visible");
            $('#module_html_editor').show().removeClass('render');
        }else{
    	    $('#module_html_editor').hide();
    	    $('#module_html_editor').css('visibility','hidden');
        }
        ...
        if(!decoration.editor) {		
        	...
        	decoration.editor =  new UE.ui.Editor(options);
        	decoration.editor.render("module_html_editor");
        }
        
        decoration.editor.addListener("ready", function () {
            //editor准备好之后才可以使用
        	//decoration.editor.setContent('的房间看规划师的疯狂建国后');
        });       
    };
    ...
    $('#btn_save_background').on('click', function() {
        var post = { 
            ...
            background_image_url: $('#img_background_image').attr('src'),
    ...
    $('#btn_save_decoration_banner').on('click', function() {
        ...
        var banner_image = $('#img_banner_image').attr('src');  //$('#txt_banner_image').val();
    ...
    $('#btn_save_module_html').on('click', function() {
        ...
        if(decoration.editor.hasContents()){
        	decoration.editor.sync();
        }
    ...
    $('#btn_save_module_slide').on('click', function() {
        ...
        $('#module_slide_html li').each(function() { 
            var image = {};
            image.image_url = $(this).attr('data-image-url');
    ...
    $('#btn_save_module_hot_area').on('click', function() {
        ...
        data.image_url = decoration.$hot_area_image.attr('src');
        if(data.image == '') {
    ...
    //商品模块搜索结果翻页
    $('#div_module_goods_search_list').on('click', 'a', function() {
    ...
    $('#btn_save_module_goods').on('click', function() {
        ...
        $('#div_module_goods_list').find('[nctype="goods_item"]').each(function() { 
            ...
            goods.shop_price = $(this).attr('data-goods-price');
